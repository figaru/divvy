Template.createPost.helpers({
  'getCopy':function(){
    ...
    return Session.get("post-creation");
  },
  'getCopyTags':function(){
    var data = Session.get("post-creation");
    ...
    return Session.get("post-creation").tags;
  } 
});

Template.createPost.events({
  'keyup .js-post-description': _.throttle(function(event, template) {
      var data = Session.get("post-creation");
  ...
  'change .js-post-category':function(event, template) {
  ...
  'click .js-create-post':function(event, template){
    ...
    var title = Session.get("post-creation").title;
    var tags = Session.get("post-creation").tags;
    var categories = Session.get("post-creation").categories;
    var description = Session.get("post-creation").description;
    ...
    Meteor.call("createPost", data, function(err, data){
      if(err){
        console.log(err);
      }else{
        return Router.go('/');
...
Template.createPostCheck.events({
  'submit .js-form-post-create-check':function(event, template){
    event.preventDefault();

    var title = template.find("#post-create-check-input").value;

    Router.go("/post/create/validate/" + title);
  }
});
